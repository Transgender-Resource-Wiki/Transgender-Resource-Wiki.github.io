...
<div class="described-link">
  {/*Title section*/}
  <div class="dl-title">
    <a href="https://translifeline.org/tucking-guide/">Tucking Guide</a>
    <a href="https://web.archive.org/web/20240525092143/https://translifeline.org/tucking-guide/">
      <span class="tooltip">
        <img src="../icons/archive.svg" alt="Archive"/>
        <span class="tooltip-text">View on the Internet Archive</span>
      </span>
  ...
  {/*content section*/}
  <div class="dl-content">
    <p>A guide on various tucking methods. Also contains resources for acquiring a gaff.</p>
  </div>
</div>
{/*End described link (the above div)*/}
...
<div class="described-link">
  {/*Title section*/}
  <div class="dl-title">
    <a href="https://translifeline.org/binding-guide/">Binding Guide</a>
    <a href="https://web.archive.org/web/20240525092122/https://translifeline.org/binding-guide/">
      <span class="tooltip">
        <img src="../icons/archive.svg" alt="Archive"/>
        <span class="tooltip-text">View on the Internet Archive</span>
      </span>
  ...
  {/*content section*/}
  <div class="dl-content">
    <p>A detailed guide on binding. Also contains resources for acquiring a binder.</p>
  </div>
</div>
{/*End described link (the above div)*/}
...
&emsp; Another way to achieve a flatter chest is to use binding tape. Binding tape is applied to the skin, and can typically be worn for multiple days at a time. It is important that you use binding tape. Do <b>not</b> use packing tape, duct tape, bandages, etc., as they are not meant for chest binding and could potentially harm you. If you are interested in binding tape, check out this <a class="purple-link" href="https://www.gendergp.com/trans-tape-how-to-use-chest-binding-alternative/">guide</a> <a href="https://web.archive.org/web/20240216182250/https://www.gendergp.com/trans-tape-how-to-use-chest-binding-alternative/"><span class="tooltip"><img style="display:inline; vertical-align:bottom; max-width:1.5rem;" src="../icons/archive.svg" alt="archive" /><span class="tooltip-text">View on the Internet Archive</span></span></a> on it.
...
<div class="vertical-scroll-pane">
  ...
  <div class="scroll-item">
    ...
    <div class="described-link">
      {/*Title section*/}
      <div class="dl-title">
        <a href="https://www.transvoicelessons.com/">Trans Voice Lessons</a>
        {/*Subtitle*/}
        <p>Service</p>
      </div>
      {/*content section*/}
      <div class="dl-content">
        <p> Trans Voice Lessons offers private remote voice lessons for feminine, masculine, and androgynous voices. They also have a <a class="purple-link" href="https://www.youtube.com/@TransVoiceLessons">Youtube channel</a> with a large amount of voice feminization tutorials.</p>
      </div>
    </div>
    {/*End described link (the above div)*/}
  </div>
  ...
  <div class="scroll-item">
    ...
    <div class="described-link">
      {/*Title section*/}
      <div class="dl-title">
        <a href="https://www.seattlevoicelab.com/">Seattle Voice Lab</a>
        {/*Subtitle*/}
        <p>Service</p>
      </div>
      {/*content section*/}
      <div class="dl-content">
        <p> Seattle Voice Lab offers private remote lessons on their website for feminine, masculine, and androgynous voices. Seattle Voice Lab also has a <a class="purple-link" href="https://www.youtube.com/@seattlevoicelab">YouTube channel</a> with many short voice training tutorials.</p>
      </div>
    </div>
    {/*End described link (the above div)*/}
  </div>
  ...
  <div class="scroll-item">
    ...
    <div class="described-link">
      {/*Title section*/}
      <div class="dl-title">
        <a href="https://www.undeadvoice.com/">Undead Voice Lab</a>
        {/*Subtitle*/}
        <p>Service</p>
      </div>
      {/*content section*/}
      <div class="dl-content">
        <p>Undead Voice Lab offers private remote lessons on their website for feminine, masculine, and androgynous voices. They also have a free voice training guide on their website and a <a class="purple-link" href="https://www.youtube.com/@undeadvoicelab">YouTube channel</a> with tutorials as well.</p>
      </div>
    </div>
    {/*End described link (the above div)*/}
  </div>
  ...
  <div class="scroll-item">
    ...
    <div class="described-link">
      {/*Title section*/}
      <div class="dl-title">
        <a href="https://acousticgender.space/">Acoustic Gender</a>
        {/*Subtitle*/}
        <p>Online Tool</p>
      </div>
      {/*content section*/}
      <div class="dl-content">
        <p>A website that allows you to upload a voice clip, where it then analyzes your pitch and resonance. </p>
      </div>
    </div>
    {/*End described link (the above div)*/}
  </div>
  ...
  <div class="scroll-item">
    ...
    <div class="described-link">
      {/*Title section*/}
      <div class="dl-title">
        <a href="https://voice.hydev.org/">Voice Tools</a>
        {/*Subtitle*/}
        <p>Online Tool</p>
      </div>
      {/*content section*/}
      <div class="dl-content">
        <p>An online tool that analyzes your voice. As of May 2024, it seems to still be in development.</p>
      </div>
    </div>
    {/*End described link (the above div)*/}
  </div>
